...
stripe.api_key='sk_test_QUzfQYwOTe5iP5XZYzsywgIT00kXSQ0kj4'
...
def billing_profile_created_receiver(sender,instance,*args,**kwargs):
    if not instance.customer_id and instance.email:
        print("API Request of the Customer is Send to Stripe")
...
pre_save.connect(billing_profile_created_receiver,BillingProfile)

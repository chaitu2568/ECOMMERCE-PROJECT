...
alert("Please give only Unique Payment Details")
...
function redirectToNext(nextPath,timer){
if (nextPath){
  setTimeout(function() {
...
$.ajax({
  ...
  success:function(data) {
    // get the success msg as an Json response from the server
    var successMsg=data.message || 'Successfully Card is Added'
    card.clear()
    if (nextUrl){
